# from .  import LandslideRainFall
# import importlib 
# importlib.reload(LandslideRainFall)
from os import name
from sklearn.model_selection import StratifiedKFold
import numpy as np
import tensorflow as tf
from .LandslideRainfall import LandslideRainFall

from .data import CategoricalEncoderLayer, NormalizationLayer, dataframe_to_dataset
import sklearn
from matplotlib import pyplot as plt

SKIP_NORMALIZATION = {'soil_type_idx'}


def train_model_rainfall(df, numerical_cols, categorical_cols, feature_cols, pga_col, path:str, epochs=200, batch_size=128):
    """
        Trains model using stratified KFold
        Adds Pore Pressure term in Factor of Safety
    """
...
def train_rainfall_with_calculated_m(df, numerical_cols, categorical_cols, feature_cols, pga_col, m_col, path:str, epochs=200, batch_size=128):
    pass