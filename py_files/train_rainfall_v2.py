...
from .LandslideRainfall_v2 import LandslideRainFallV2
...
def train_model_rainfall_v2(df, numerical_cols, categorical_cols, feature_cols, pga_col, path: str, epochs=200, batch_size=128, lambda_var=0.01):
    """
        Trains rainfall PINN model v2 using stratified KFold.
        Uses SoilConditionedGeotechLayer for soil-type-conditioned coh/ifi.
    """
